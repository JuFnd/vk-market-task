...
func ReadMarketAppConfig() (*variables.AppConfig, error) {
	return ParseFlagsAndReadYAMLFile[variables.AppConfig]("market_config_path", "../../configs/MarketAppConfig.yml", flag.CommandLine)
}
...
func ReadRelationalMarketDataBaseConfig() (*variables.RelationalDataBaseConfig, error) {
	return ParseFlagsAndReadYAMLFile[variables.RelationalDataBaseConfig]("sql_config_films_path", "../../configs/MarketSqlDataBaseConfig.yml", flag.CommandLine)
}
